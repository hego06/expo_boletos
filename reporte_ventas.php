		...
		<main class="dashboard-full-size" onclick="openNav('')">
			<div class="row">
                <div class="col-md-12 work-container">
                    <div class="tit_caja1"><i class="fa fa-home icon-home-route"></i>Inicio <i class="fa fa-angle-right icon-arrow-route"></i> REPORTE DE INGRESOS</div>
					<div class="work-area-box"><br>
                    	<div class="col-md-12 subtitulo-azul">REPORTE DE INGRESOS</div>
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="col-md-4">
										<input type="date" name="fecha1" id="fecha1" class="input-work filtra" onChange="reporteVtas()" value="<?php echo $hoy; ?>">
									</div>
									<div class="col-md-2 subtitulo-rosa">
										AL
									</div>
									<div class="col-md-4">
										<input type="date" name="fecha2" id="fecha2" class="input-work filtra" onChange="reporteVtas()" value="<?php echo $hoy; ?>">
									</div>
								</div>
							</div>
						</div>
								...
								<div class="col-md-10" >
									...
									<?php 
                                            if($_SESSION['dep']!=13 && $_SESSION['dep']!=10 && $_SESSION['id'] != '00106' && $_SESSION['id'] != '00814' && $_SESSION['dep']!=19 ){
                                                ...
                                                echo '<select name="ejecutivo" id="ejecutivo" onchange="reporteVtas()" class="input-work filtra">';
                                                        opcionesEmp("x");                                   
                                                echo '</select>';
                                            }
                                    ?>
						...
						<div class="col-md-12">
							...
							<div class="row right-15" style="overflow:auto;height: 660px;" id="registrosVtas"></div>
						</div>	
					</div>
				</div>
			</div>
