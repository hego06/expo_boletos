<?php
	...
	if($_GET['tipo']=='N'){
		...
		$consulta 	= "SELECT * FROM expo_mov WHERE fecha BETWEEN '$fecha1' AND '$fecha2' $extra";
		...
		if (mysqli_num_rows($res)>0){
			...
			while($row = mysqli_fetch_assoc($res)) {
				...
				$ligaV	= encode_this("folio=".$folio."&v=1");

				if( ($estatus == 'X' || $estatus == 'E') && $lamm != '1'){

					$editar 	= "<td style='text-align:center;cursor:pointer;font-size: 22px; font-weight: bolder;'>

									<a href='https://".$_SERVER['SERVER_NAME']."/expo2017/index.php?".$ligaF."'><i data-toggle='tooltip' data-placement='bottom' title='EDITAR' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>
				...
				$ver 	= "<td style='text-align:center;cursor:pointer;font-size: 22px; font-weight: bolder;'>
									...
									<a href='https://".$_SERVER['SERVER_NAME']."/expo2017/index.php?".$ligaV."'><i data-toggle='tooltip' data-placement='bottom' title='VER' class='glyphicon glyphicon-eye-open' aria-hidden='true'></i></a>
