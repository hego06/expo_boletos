<?php
	...
	if($_GET){
		...
		$folexpo	= $_GET['folexpo'];	

		$liga		= encode_this("folio=".$folexpo);
		...
		$fechsaop 	= ddmmmaaaa($row['fechsaop']);
		...
		if($cancelado == 1){
			...
			$tabla_cancelado	= "<tr>
										...
										<td colspan='4' align='right'>
											...
											<table style='font-size:9px;' cellpadding='0' cellspacing='0'>
		...
		<td>
			...
			<table class='direc' width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
				...
				<tr>
					...
					<td>Naucalpan CP 53040 Estado de México</td>
			...
			<table width='100%'>
				...
				<tr>
					...
					<td>
						...
						<img src='http://lax.megatravel.com.mx/expo/img/rfcmega.jpg' width='120' height='120'>

					</td>

					<td rowspan='4' align='justify' style='font-size:8px;  color: #666; font-family: 'Times New Roman', Times, serif;' valign='top'>
...
<meta http-equiv="refresh" content="0; url=../procesa_pago.php?<?php echo $liga?>">

<!--//location(header: '../procesa_pago.php?');
