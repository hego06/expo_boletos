		...
		<main class="dashboard-full-size" onclick="openNav('')">
			...
			<div class="row">
                ...
                <div class="col-md-12 work-container">
                    ...
                    <div class="tit_caja1"><i class="fa fa-home icon-home-route"></i>Inicio <i class="fa fa-angle-right icon-arrow-route"></i> REGISTROS CAPTURADOS</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="col-md-3">
										...
										<input type="date" name="fecha1" id="fecha1" class="input-work filtra" onChange="reporteEjec()" value="<?php echo $hoy; ?>">
									...
									<div class="col-md-3">
										...
										<input type="date" name="fecha2" id="fecha2" class="input-work filtra" onChange="reporteEjec()" value="<?php echo $hoy; ?>">
...
<?php 
		...
		if($_SESSION['dep']!=13 && $_SESSION['dep']!=10 && $_SESSION['id'] != '00106' && $_SESSION['dep'] != '23'){ 
			...
			echo '<select name="ejecutivo" id="ejecutivo" onchange="reporteEjec()" class="input-work filtra">';
...
?>
						...
						<div class="col-md-12">
							...
							<div class="row right-15" style="overflow:auto;height: 800px;" id="registrosEjec"></div>
